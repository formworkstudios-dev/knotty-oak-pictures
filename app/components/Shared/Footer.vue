...
<template>
  <div
    ...
    class="footer-anim bg-amber-50 border-t border-stone-200 p-4 text-sm text-stone-700 flex flex-col md:flex-row items-center justify-center w-full gap-2 md:gap-4"
  >
